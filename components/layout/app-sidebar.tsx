...
export function AppSidebar() {
  ...
  return (
    ...
    >
      ...
      {/* ── User card ── */}
      <div className="p-3" style={{ borderTop: `1px solid ${C.divide}` }}>
        <button
          className="flex w-full items-center gap-2.5 rounded-lg p-2 transition-colors hover:bg-white/5"
        >
          <div
            className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-blue-500 text-[12px] font-bold text-white"
          >
            AK
          </div>
          <div className="min-w-0 flex-1 text-left">
            <p
              ...
              style={{ color: C.textActive, fontWeight: 600 }}
            >
              Akbar Rayyan
            </p>
            <p
          ...
          <svg
            ...
            style={{ color: C.chevron, flexShrink: 0 }}
          >
